document.addEventListener("DOMContentLoaded", function () {
    ...
    volumenButton.addEventListener("click", function () {
        ...
        if (isMuted) {
            ...
            isMuted = false;
            volumenButton.innerHTML = '<img src="https://cmr-ciaa.s3.amazonaws.com/cmr/imagen/img-video/bxs-volume-full.svg " alt="volumen">';
            barraVolumen.value = video.volume * 50;
        } else {
            video.muted = true; //activa el modo silencio
            isMuted = true;
            volumenButton.innerHTML = '<img src="https://cmr-ciaa.s3.amazonaws.com/cmr/imagen/img-video/bxs-volume-mute.svg" alt="silenciar">';
